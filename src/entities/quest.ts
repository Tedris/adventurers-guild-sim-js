...
export const QUEST_TEMPLATES: QuestTemplate[] = [
  ...
  // Phase 11 — New quests: Defense + Social archetypes
  // Defense archetype (physical fortification, military defense)
  { name: 'Reinforce the watchtower', difficulty: 2, requirements: { minStats: { str: 7, dex: 5, int: 4, vit: 6, lck: 5 }, preferredClasses: ['Sword', 'Shield', 'Axe'], minPartySize: 1, maxPartySize: 3 }, rewards: { gold: 27, experience: 35 }, description: 'The eastern watchtower needs reinforcement. Strengthen the defenses before the next attack.' },
  { name: 'Hold the mountain pass', difficulty: 3, requirements: { minStats: { str: 10, dex: 7, int: 5, vit: 9, lck: 7 }, preferredClasses: ['Sword', 'Shield', 'Axe'], minPartySize: 2, maxPartySize: 3 }, rewards: { gold: 45, experience: 52 }, description: 'Enemy forces are pushing through the mountain pass. Hold the line until reinforcements arrive.' },
  { name: 'Fortify the frontier settlement', difficulty: 4, requirements: { minStats: { str: 12, dex: 8, int: 6, vit: 11, lck: 8 }, preferredClasses: ['Sword', 'Shield', 'Axe', 'Mace'], minPartySize: 2, maxPartySize: 3 }, rewards: { gold: 62, experience: 70 }, description: 'A frontier settlement is under pressure. Fortify the settlement and secure the surrounding roads.' },
  // Social archetype (community building, diplomacy)
  { name: 'Organize the harvest festival', difficulty: 2, requirements: { minStats: { str: 5, dex: 5, int: 6, vit: 5, lck: 7 }, preferredClasses: ['Wand', 'Staff', 'Shield'], minPartySize: 1, maxPartySize: 3 }, rewards: { gold: 28, experience: 35 }, description: 'The harvest festival approaches. Organize the event to boost community morale and attract settlers.' },
  { name: 'Establish the trade guild', difficulty: 3, requirements: { minStats: { str: 6, dex: 6, int: 9, vit: 7, lck: 9 }, preferredClasses: ['Wand', 'Staff', 'Shield'], minPartySize: 2, maxPartySize: 3 }, rewards: { gold: 45, experience: 53 }, description: 'The region lacks organized trade. Establish a trade guild to connect settlements and increase revenue.' },
  { name: 'Negotiate the regional alliance', difficulty: 4, requirements: { minStats: { str: 7, dex: 7, int: 12, vit: 8, lck: 11 }, preferredClasses: ['Wand', 'Staff', 'Shield'], minPartySize: 2, maxPartySize: 3 }, rewards: { gold: 63, experience: 70 }, description: 'Neighboring settlements are divided. Negotiate a regional alliance to strengthen cooperation.' },
];
